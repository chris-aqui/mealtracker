class Test {
    ...
    public static void main(String[] args) {
        ...
        User Chris = new User("Chris", "Aqui", "chris@mail.com", 80);

        System.out.println("My name is " + Chris.getFirstName());

        System.out.println("My last name is " + Chris.getLastName());

        System.out.println("My email address is " + Chris.getEmail());

        System.out.println("My goal for complete meals is " + Chris.getTargetAdherence() + "%");
        ...
        System.out.println("I am eating" + Pizza.getName() + " for dinner.");
        ...
        MealTracker Monday = new MealTracker(Chris);
        Monday.addMeal(meal);
